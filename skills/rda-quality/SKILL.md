...
- Verify whether ADR assumptions are validated by:
    - tests (where feasible)
    - runbooks/operational checks (where tests can’t cover)
- If you see drift: label as **DRIFT** (with impact + fix).
- If you think the decision is poor: label as **DECISION RISK** (with safer alternatives).
