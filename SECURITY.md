...
- **Fix publication:** Security fixes will be released as patch versions (e.g., 0.1.6) with clear CHANGELOG entries.
...
3. **Create signed tag:** `git tag -s v0.1.6 -m "Release v0.1.6: Security fixes"`
