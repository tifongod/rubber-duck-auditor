...
- **Fix publication:** Security fixes will be released as patch versions (e.g., 0.1.2) with clear CHANGELOG entries.
...
3. **Create signed tag:** `git tag -s v0.1.2 -m "Release v0.1.2: Security fixes"`
...
- [ ] Does prompt follow "Shared Rules" (GUARDRAILS.md, rda-common-rules.md)?
