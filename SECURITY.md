...
- **Fix publication:** Security fixes will be released as patch versions (e.g., 0.1.3) with clear CHANGELOG entries.
...
3. **Create signed tag:** `git tag -s v0.1.3 -m "Release v0.1.3: Security fixes"`
